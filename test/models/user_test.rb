...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid addresses" do 
    valid_addresses = %w[tony@example.com JOHN@test.com MARY_smith-01@new.com tony.smith@example.com christine+myerskeitt@example.com]
  ...
  test "email validation should not accept invalid addresses" do 
    invalid_addresses = %w[tony@example,com JOHN_test_example.com MARY_smith-01@new. christine+myerskeitt@ex+ample.com]
